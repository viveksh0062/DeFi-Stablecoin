...
contract DSCEngine is ReentrancyGuard {
    ...
    * @notice follows CEI
    ...
    /*
     * @param tokenCollateralAddress The collateral address of the token
    ...
    */
     ...
     * @notice A know bug would be if the protocol were 100% or less collateralized, then we would'nt be able to incentivise liquidators
    ...
    ///////////////////////////////////////
    /*
     * @dev Low-level interaction function, do not call unless the function calling it is
     * checking for health function being broken
     */
